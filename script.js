function play() {
var audio = new Audio('https://storage.caliph.my.id/audio/Dandelions.mp3');audio.play();}
function nonFt() {document.getElementById('caca.jpg').style.display = "none";} function showFt() {document.getElementById('caca.jpg').style.display = "block";}
  ...
  function fotoKt() {document.getElementById('caca.jpg').style.margin = "0 110px 0 0";document.getElementById('caca.jpg').style.opacity = "1";document.getElementById('ftAk').style.margin = "0 0 0 60px";
  var e1 = document.getElementById('caca.jpg');e1.classList.add("degdeg");var e2 = document.getElementById('caca.jpg');e2.classList.add("degdeg");}
